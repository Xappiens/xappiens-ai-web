import { Book, Info, MessageSquare, Phone } from "lucide-react";
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="md:w-1/2 animate-fade-in">
                ...
                <p className="text-lg mb-8 text-gray-200">
                  ...
                  desarrollo de aplicaciones, inteligencia artificial, formación
                  y consultoría para empresas que quieren liderar el futuro.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link to="/servicios">
                    <Button
                      size="lg"
                      className="bg-white text-xappiens-blue hover:bg-gray-100"
                    >
                      Nuestros servicios
                    </Button>
                  </Link>
                  <Link to="/contacto">
                    <Button
                      size="lg"
                      variant="outline"
                      className="bg-xappiens-purple text-white border-white hover:bg-white hover:text-xappiens-blue transition-colors duration-200"
                    >
                      Contáctanos
                    </Button>
                  </Link>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Ofrecemos soluciones integrales para impulsar tu empresa en la
                era digital
              </p>
            </div>
            ...
            <div className="text-center mt-12">
              <Link to="/servicios">
                <Button
                  size="lg"
                  className="bg-xappiens-purple hover:bg-xappiens-blue"
                >
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2 md:pl-12">
                <h2 className="text-3xl font-bold mb-6">
                  ¿Por qué elegir Xappiens?
                </h2>
                <p className="text-lg text-gray-600 mb-6">
                  Somos un equipo de profesionales apasionados por la tecnología
                  y la innovación, con amplia experiencia en el sector IT y un
                  enfoque centrado en resultados.
                </p>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <span className="bg-xappiens-purple/10 text-xappiens-purple p-2 rounded-full mr-3">
                      ✓
                    </span>
                    <p className="text-gray-600">
                      Equipo de expertos en tecnología e innovación
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-xappiens-purple/10 text-xappiens-purple p-2 rounded-full mr-3">
                  ...
                  <li className="flex items-start">
                    ...
                    <p className="text-gray-600">
                      Metodologías ágiles para una entrega rápida y eficiente
                    </p>
                  </li>
                  <li className="flex items-start">
                    <span className="bg-xappiens-purple/10 text-xappiens-purple p-2 rounded-full mr-3">
